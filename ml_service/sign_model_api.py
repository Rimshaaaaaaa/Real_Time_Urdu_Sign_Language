...
# === Load Model and Label Encoder with RELATIVE PATHS ===
try:
    model = build_model()
    model.load_weights("best_hybrid_model.h5")   # ✔ relative path for Render
    print("✅ Model loaded successfully!")

    with open("label_encoder.pkl", "rb") as f:    # ✔ relative path for Render
